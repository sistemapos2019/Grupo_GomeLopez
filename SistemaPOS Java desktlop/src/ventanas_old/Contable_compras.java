 ...
 * @author Miguel
 */
public class Contable_compras extends javax.swing.JFrame {

    /**
     * Creates new form Contable_compras
     */
    public Contable_compras() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informe contable de compras");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Fecha Emision", "No. Documento", "NRC", "DUI", "Nombre proveedor", "Compras internas", "Compras importacion e internacionales", "Compras credito fiscal", "Total compras"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Contable_compras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contable_compras().setVisible(true);
            }
        });
    }
